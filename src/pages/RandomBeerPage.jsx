...
function RandomBeersPage() {
 ...
 useEffect(() => {
    // Fetch a random beer when the component mounts
    axios.get('https://beers-api.edu.ironhack.com/beers/random')
      .then(response => {
        setRandomBeer(response.data); // Update state with fetched beer
      })
      .catch(error => {
  ...
  // While we wait for the data, show a loading message
